...
[Ned's GitHub Repository](https://github.com/stat301-3-2026-spring/l01-review-nedyu119.git)
:::
...
* Find a dataset and find a target variable of interest. Establish a research question (ex. decide between inferential vs predictive models).
* Use EDA and establish predictors of interest.
* Split the data into training and testing data (choose a ratio depending what you've defined).
* Define recipes for each model you plan on using, and create a workflow for each.
* Identify hyperparameters of interest for each model
* Set up a resampling process (ex. v-fold cross validation, bootstrap) and split the training data accordingly.
